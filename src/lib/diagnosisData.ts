...
export const diagnosisTrees: Record<string, DiagnosisTree> = {
  ...
  'nao-faz-descarga': {
    ...
    results: {
      ...
      'result-torneira-fechada': { id: 12, title: 'Entrada de Água Bloqueada', description: 'A torneira de segurança está fechada.', cause: 'Torneira fechada', difficulty: 'simples', time: '2 min', priority: 'importante', solution: 'Abrir a torneira', isDIY: true, price: 4.99 },
  ...
  'sanita-entupida': {
    ...
    results: {
      ...
      'apartamento,varias': { id: 21, title: 'Coluna do Prédio', description: 'Problema na coluna comum do prédio.', cause: 'Coluna comum entupida', difficulty: 'avancado', time: 'Condomínio', priority: 'urgente', solution: 'Contactar condomínio', isDIY: false, price: 4.99 },
      ...
      'vivenda,varias': { id: 23, title: 'Fossa/Esgoto Principal', description: 'Rede principal entupida.', cause: 'Esgoto principal', difficulty: 'avancado', time: '1-2 horas', priority: 'urgente', solution: 'Chamar canalizador com jato de água', isDIY: false, price: 4.99 }
    }
  },
  ...
  'sanita-vazamento': {
    ...
    results: {
      ...
      'constante,firme': { id: 33, title: 'Fissura na Louça', description: 'Possível fissura impercetível na sanita.', cause: 'Porcelana estalada', difficulty: 'avancado', time: '2-3 horas', priority: 'urgente', solution: 'Mudar a sanita inteira', isDIY: false, price: 4.99 }
    }
  },
  'sanita-mau-cheiro': {
    problemId: 5,
    ...
    results: {
      'raramente,sim': { id: 40, title: 'Sifão Seco', description: 'Água evaporou, o esgoto está direto para casa.', cause: 'Sifão sem água', difficulty: 'simples', time: '1 min', priority: 'quando-possivel', solution: 'Fazer descargas em WCs sem uso', isDIY: true, price: 4.99 },
      'raramente,nao': { id: 41, title: 'Sifão Seco', description: 'Água evaporou, o esgoto está direto.', cause: 'Sifão sem água', difficulty: 'simples', time: '1 min', priority: 'quando-possivel', solution: 'Fazer uma descarga', isDIY: true, price: 4.99 },
      'diariamente,sim': { id: 42, title: 'Entupimento Parcial / Má Ventilação', description: 'Entupimento na rede cria sucção e esvazia o sifão.', cause: 'Problema ventilatório ou pré-entupimento', difficulty: 'avancado', time: '1-2 horas', priority: 'importante', solution: 'Chamar canalizador para limpar linha', isDIY: false, price: 4.99 },
  ...
  'lavatorio-entupido': {
    ...
    results: {
      'parada': { id: 50, title: 'Entupimento Total', description: 'Bloqueio total no sifão.', cause: 'Obstrução completa', difficulty: 'simples', time: '15 min', priority: 'urgente', solution: 'Usar desentupidor com força ou remover o sifão para limpeza completa.', isDIY: true, price: 4.99 },
      'nao': { id: 51, title: 'Limpeza de Manutenção', description: 'O problema parece ser superficial.', cause: 'Pequenos detritos no ralo.', difficulty: 'simples', time: '10 min', priority: 'quando-possivel', solution: 'Remova a tampa do ralo e limpe manualmente o que conseguir alcançar.', isDIY: true, price: 4.99 },
  ...
  'lavatorio-torneira': {
    ...
    results: {
      'result-cartucho-ceramico': { id: 70, title: 'Cartucho de Discos Cerâmicos Gasto', description: 'O mecanismo interno que controla o fluxo está danificado.', cause: 'Desgaste natural ou areias na água.', difficulty: 'medio', time: '30 min', priority: 'importante', solution: 'Identifique a marca e substitua o cartucho cerâmico interno.', isDIY: true, price: 4.99 },
      'result-vedante-borracha': { id: 71, title: 'Vedante (Gaxeta) Danificado', description: 'A borracha que veda a passagem de água está deformada.', cause: 'Aperto excessivo ou calcário.', difficulty: 'simples', time: '15 min', priority: 'importante', solution: 'Substitua a anilha de borracha (vedante) interna da manete.', isDIY: true, price: 4.99 }
    }
  },
  ...
  'cozinha-agua-sobe': {
    ...
    results: {
      'sim,sim': { id: 110, title: 'Prumada Entupida', description: 'O prédio não deixa despachar. Faz BackFlow.', cause: 'Má capacidade da linha local ou partilhada do tubo.', difficulty: 'avancado', time: 'N/A', priority: 'urgente', solution: 'Contactar Profissional p/ desentupimento robot/pressão de linha', isDIY: false, price: 4.99 },
      'sim,nao': { id: 111, title: 'Prumada Entupida', description: 'O mesmo cenário grave.', cause: 'Linha bloqueada fora do controlo individual.', difficulty: 'avancado', time: 'N/A', priority: 'urgente', solution: 'Técnico Especializado ou Condomínio.', isDIY: false, price: 4.99 },
      ...
      'nao,nao': { id: 113, title: 'Entupimento Parcial da Ligação Oculta', description: 'Ao atirar a àgua pesada em segundos a parede bloqueia mas no resto do tempo flui pingas.', cause: 'Acúmulo de pó de lavagem / pedra de sabões e têxteis entupindo logo a entrada de parede.', difficulty: 'avancado', time: '1-2h', priority: 'importante', solution: 'Necessário sonda elíptica de desentupidor em tubo rígido de chumbo. Cuidado para não vazar a parede interior.', isDIY: false, price: 4.99 }
    }
  },
  ...
  'chuveiro-entupido': {
    ...
    results: {
      ...
      'sim,multiplo': { id: 132, title: 'Rede Central Entupida', description: 'Todos têm a conexão tapada na espinha do W.C.', cause: 'Gargalos cheios até à laje estrutural de esgotos mestres.', difficulty: 'avancado', time: '2h', priority: 'urgente', solution: 'Ligar empresa. Pode criar inundações em divisões contínuas muito rápido se tomar banhos ali', isDIY: false, price: 4.99 },
      'nao,multiplo': { id: 133, title: 'Esgotos Subterrâneos Gerais', description: 'O próprio coletor da casa fechou-se e todos desaguadouros estão num único barco.', cause: 'Colapso profundo.', difficulty: 'avancado', time: '2h', priority: 'urgente', solution: 'Serviço profissional imediato (máquina a hidrojateamento mola vibratória)', isDIY: false, price: 4.99 }
    }
  },
  'lavatorio-vazamento': {
    problemId: 9,
  ...
  'banheira-mau-cheiro': {
    ...
    results: {
      'result-cabelos-limpeza': { id: 170, title: 'Resíduos Fermentados no Ralo', description: 'Bactérias acumulam-se nos cabelos presos na saída.', cause: 'Resíduos de champô e cabelos retidos na válvula.', difficulty: 'simples', time: '15 min', priority: 'quando-possivel', solution: 'Verta água a ferver com detergente e remova cabelos visíveis.', isDIY: true, price: 4.99 },
      'result-caixa-sifonica-seca': { id: 171, title: 'Evaporação por Desuso', description: 'Falta de selo hídrico na ligação geral.', cause: 'Desuso prolongado.', difficulty: 'simples', time: '1 min', priority: 'quando-possivel', solution: 'Deixe correr água por algum tempo em todos os sanitários.', isDIY: true, price: 4.99 }
    }
  },
  ...
  'banheira-torneira': {
    ...
    results: {
      'result-mecanismo-manete': { id: 180, title: 'Mecanismo Ceramic Interno Gasto', description: 'O controlo de temperatura/fluxo não veda a 100%.', cause: 'Uso constante ao longo dos anos.', difficulty: 'medio', time: '40 min', priority: 'importante', solution: 'Substitua o cartucho misturador de 35mm ou 40mm conforme a marca.', isDIY: true, price: 4.99 },
      'result-inversor-danificado': { id: 181, title: 'Vedante do Inversor Estragado', description: 'O botão que vira para o chuveiro não fecha bem a outra saída.', cause: 'Calcário acumulado no vedante do inversor.', difficulty: 'medio', time: '30 min', priority: 'importante', solution: 'Desmonte o inversor (o botão de puxar) e descalcifique com vinagre.', isDIY: true, price: 4.99 }
    }
  },
  ...
  'baixa-pressao': {
    ...
    results: {
      'todas,nao': { id: 170, title: 'Válvula de Entrada Parcialmente Fechada', description: 'A torneira do contador ou de segurança da casa não estava totalmente aberta.', cause: 'Registo fechado acidentalmente ou por obras anteriores.', difficulty: 'simples', time: '2 min', priority: 'importante', solution: 'Abrir a válvula principal de segurança na totalidade.', isDIY: true, price: 4.99 },
      ...
      'apenas-uma,ambas': { id: 172, title: 'Arejador/Filtro Entupido com Calcário', description: 'O bico da torneira/filtro do chuveiro está cheio de lixo e minerais.', cause: 'Depósitos minerais (calcário) e sedimentos bloqueiam a saída.', difficulty: 'simples', time: '10 min', priority: 'quando-possivel', solution: 'Desapertar a ponta da torneira e mergulhar em vinagre para dissolver o calcário.', isDIY: true, price: 4.99 },
      'apenas-uma,apenas-quente': { id: 173, title: 'Bloqueio no Esquentador/Termoacumulador', description: 'A fuga de fluxo acontece depois da água passar pelo aquecimento.', cause: 'Sedimentos ou calcário a bloquear os tubos de saída do aparelho de aquecimento.', difficulty: 'medio', time: '1h', priority: 'importante', solution: 'Necessário limpar/purgar o esquentador ou descalcificar. Chamar técnico se a gás.', isDIY: false, price: 4.99 }
    }
  },
  ...
  'fuga-oculta': {
    ...
    results: {
      'sim,roda': { id: 180, title: 'Fuga de Água Ativa com Danos', description: 'Há uma ruptura a deixar sair água para as paredes constantemente.', cause: 'Corrosão, tubagens antigas ou juntas mal vedadas soltaram-se.', difficulty: 'avancado', time: 'Dias', priority: 'urgente', solution: 'Fechar água urgente! Chamar detetor de fugas especializado para partir no sítio certo.', isDIY: false, price: 4.99 },
      'sim,nao-roda': { id: 181, title: 'Infiltração ou Fuga Passiva', description: 'A mancha deve vir de esgotos, de fora (chuva) ou do vizinho.', cause: 'Ruptura no circuito de esgotos ou isolamento exterior, já que a pressão de entrada não tem fuga.', difficulty: 'avancado', time: 'Dias', priority: 'importante', solution: 'Investigar tetos, vizinhos ou telhado. Reparar calafetagens do chuveiro.', isDIY: false, price: 4.99 },
      'nao,roda': { id: 182, title: 'Fuga Oculta (Água a Rolar na Sanita?)', description: 'Não há humidade porque a água pode estar a ir direta para o esgoto.', cause: 'Frequentemente é fuga no autoclismo, válvula sempre a deixar passar água devagar.', difficulty: 'medio', time: '1h', priority: 'importante', solution: 'Aplicar corante alimentar no autoclismo e ver se pinta a sanita. Se sim, substituir válvulas do tanque!', isDIY: true, price: 4.99 },
  ...
  'termoacumulador-frio': {
    ...
    results: {
      ...
      'tanque': { id: 223, title: 'Tanque Perfurado (Fim de Vida)', description: 'O balão interno de aço está com ferrugem e furado.', cause: 'Oxidação galvânica. O ânodo de sacrifício desapareceu.', difficulty: 'avancado', time: '3h', priority: 'urgente', solution: 'O aparelho não tem reparação viável. Necessita de um termoacumulador novo.', isDIY: false, price: 4.99 }
    }
  },
